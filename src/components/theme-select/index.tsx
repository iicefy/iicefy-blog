...
import { setThemeMode } from "@/helper/utils";
...
const ThemeSelect = () => {
  ...
  return (
    ...
    >
      ...
      {THEME_LIST.map((item) => (
        <div
          className={`relative inline-flex h-7 w-7 cursor-pointer items-center justify-center transition-colors ${item.value === currentTheme
            ? "text-slate12"
