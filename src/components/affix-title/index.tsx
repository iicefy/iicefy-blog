        ...
        >
            <div className="mx-auto flex items-center justify-between px-4 max-w-180">
                <button
                    ...
                    className="text-slate11 hover:text-slate12 transition-colors w-8 cursor-pointer active:scale-95 rounded-xl h-6 flex items-center justify-center hover:bg-slate12/5"
                >
                    ←
                </button>
